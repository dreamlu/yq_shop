...
func (this *LoginController) Get() {
	...
	//获取openid接口
	te_uri := "https://api.weixin.qq.com/sns/jscode2session?appid=wx957183cb1d4af567&secret=2f4571a570a2215619f48139046173af&js_code="+code+"&grant_type=authorization_code"
